...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/task_profiles_28.json:$(TARGET_COPY_OUT_VENDOR)/etc/task_profiles.json
endif
...
ifeq ($(UCLAMP_FEATURE_ENABLED),true)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/powerhint/vendor/powerhint-uclamp.json:$(TARGET_COPY_OUT_VENDOR)/etc/powerhint.json
else
PRODUCT_COPY_FILES += \
